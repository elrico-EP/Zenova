...
export const FirebaseSetupScreen: React.FC = () => {
    ...
    const handleSave = () => {
        ...
        setTimeout(() => {
            ...
            // Esta función extrae los valores de las claves, incluso si el usuario pega todo el bloque de código.
            ...
            if (!config.apiKey || !config.authDomain || !config.projectId) {
                setError(`Validación fallida. No se encontraron todas las claves necesarias.\n\n- apiKey: ${config.apiKey ? '✅' : '❌'}\n- authDomain: ${config.authDomain ? '✅' : '❌'}\n- projectId: ${config.projectId ? '✅' : '❌'}\n\nPor favor, pega el objeto firebaseConfig completo.`);
                setStatus('error');
                return;
            }
            ...
            try {
                ...
                setError(`Error al guardar la configuración: ${(e as Error).message}`);
                setStatus('error');
            }
        }, 100);
    };
    ...
    const getButtonContent = () => {
        switch (status) {
            ...
            case 'error': return 'Intentar de Nuevo';
            default: return 'Guardar Configuración y Iniciar App';
        }
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-zen-50 to-zen-100 flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-2xl">
                <div className="text-center mb-6">
                    ...
                    <p className="mt-2 text-md text-zen-600">
                    ...
                    {status !== 'success' ? (
                        <>
                            <div className="space-y-3 text-sm text-slate-700 text-left">
                                ...
                                <p><strong>Paso 3:</strong> En la sección "Tus apps", busca tu aplicación web y selecciona la opción <code className="bg-slate-200 p-1 rounded text-xs">Configuración</code>.</p>
                                <p><strong>Paso 4:</strong> Copia el bloque de código que contiene el objeto `firebaseConfig` y pégalo abajo.</p>
                            </div>
                        ...
                        <div className="text-center">
                            ...
                            <div className="mt-2 px-7 py-3">
                                <p className="text-sm text-gray-500">
                                    La aplicación se recargará ahora. Si no lo hace, por favor, haz clic en el botón de abajo.
                                </p>
                            </div>
