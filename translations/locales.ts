export const locales = {
  es: {
    ...
    individual_hours_difference: "Diferencia",
  ...
  en: {
    ...
    individual_hours_difference: "Difference",
  ...
  fr: {
    ...
    'planner.generate_rest_year_confirm_intelligent': 'Êtes-vous sûr ? Ceci générera des postes pour tous les jours non assignés manuellement, écrasant toute planification automatique précédente. Les postes que vous avez saisis manuellement ne seront pas modifiés. Cette action n\'est pas facilement réversible.',
    ...
    individual_hours_difference: "Différence",
