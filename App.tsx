...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    if (frozenSchedules['2026-05'] && year === 2026 && nurses.length > 0) {
      ...
      if (!hasRegeneratedMay) {
        ...
        const nursesForMay = getNursesForDate(mayDate);
        const regeneratedMay = recalculateScheduleForMonth(
          nursesForMay,
          mayDate,
          effectiveAgenda,
          manualOverrides,
  ...
  }, [year, nurses.length, effectiveAgenda, manualOverrides, vaccinationPeriod, strasbourgAssignments, jornadasLaborales, frozenSchedules, updateData, addHistoryEntry, getNursesForDate]);
